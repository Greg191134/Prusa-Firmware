...
#define DEFAULT_MAX_FEEDRATE                {200, 200, 12, 15}      // (mm/sec)   max feedrate (M203)
#define DEFAULT_MAX_FEEDRATE_SILENT         {100, 100, 12, 15}      // (mm/sec)   max feedrate (M203), silent mode
...
#define TMC2130_USTEPS_E    256       // microstep resolution for E axis
#define TMC2130_USTEP_DITH  4         // Dithering amplitude
